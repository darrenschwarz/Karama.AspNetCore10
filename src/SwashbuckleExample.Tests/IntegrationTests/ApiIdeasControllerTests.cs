...
namespace SwashbuckleExample.Tests.IntegrationTests
{
    public class ApiIdeasControllerTests : IClassFixture<TestFixture<SwashbuckleExample.Startup>>
    {
        ...
        public ApiIdeasControllerTests(TestFixture<SwashbuckleExample.Startup> fixture)
        {
