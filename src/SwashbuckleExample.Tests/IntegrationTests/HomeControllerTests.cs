...
{
    //public class HomeControllerTests : IClassFixture<TestFixture<SwashbuckleExample.Startup>>
    //{
    //    private readonly HttpClient _client;

    //    public HomeControllerTests(TestFixture<SwashbuckleExample.Startup> fixture)
    //    {
