...
namespace AspNetCoreRateLimit.Tests
{
    ...
    public class UserRateLimitAdminTests : IClassFixture<RateLimitFixture<SwashbuckleExample.Startup>>
    {
        private const string apiPeoplePath = "/api/people";

        private const string ip = "::1";

        public UserRateLimitAdminTests(RateLimitFixture<SwashbuckleExample.Startup> fixture)
        {
            Client = fixture.Client;
        }
    ...
    }//TODO: Finish off RateLimitAdminFixture and write test expectation of 401
}